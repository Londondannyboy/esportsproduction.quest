...
const CROSS_SITE_SECTIONS = [
  {
    ...
    links: [
      { label: 'Compare Insurance', href: 'https://esportsevent.quest' },
      { label: 'Insurance Guide', href: 'https://esportsevent.quest/esports-insurance-guide' },
      { label: 'UK Coverage', href: 'https://esportsevent.quest/esports-insurance-uk' },
  ...
  },
  {
    ...
    links: [
      { label: 'Production Services', href: 'https://esportsproduction.quest' },
      { label: 'Live Broadcast', href: 'https://esportsproduction.quest/#services' },
      { label: 'Production Guide', href: 'https://esportsproduction.quest/esports-production-guide' },
  ...
  },
  {
    ...
    site: 'jobs' as const,
    links: [
      { label: 'Browse Jobs', href: 'https://esportsjobs.quest' },
      { label: 'Job Categories', href: 'https://esportsjobs.quest/#categories' },
      { label: 'Career Paths', href: 'https://esportsjobs.quest/#careers' },
